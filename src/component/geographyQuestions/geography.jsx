...
import { geographyQuestions } from "./geographyBase.js";
...
export function Geography() {
  ...
  const handleQuizStart = (type) => {
    setQuizType(type);
    const questions = geographyQuestions
      ...
      {!quizType ? (
        <div className="wireframe-container">
          <div className="wireframe-box">
            <h1 className="wireframe-title"> Geography Quiz</h1>
